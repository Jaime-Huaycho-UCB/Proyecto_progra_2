...
public class AdicionTipoCuenta extends JFrame {
	...
	public AdicionTipoCuenta() {
		...
		BotonAdicionar.setIcon(new ImageIcon(AdicionTipoCuenta.class.getResource("/Imagenes/10.png")));
		...
		BotonVolver.setIcon(new ImageIcon(AdicionTipoCuenta.class.getResource("/Imagenes/8.1.png")));
		...
		BotonVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				base.CerrarConexion();
				lib.CambiarPantalla(new MenuTipoCuenta());
				dispose();
			}
		});
		...
		// Logo
		// ImageIcon logo = new ImageIcon(getClass().getResource("/ruta/del/logo.png"));
		// // Ajusta la ruta del logo según tu proyecto
		JLabel lblLogo = new JLabel(new ImageIcon(AdicionTipoCuenta.class.getResource("/Imagenes/2.jpg")));
