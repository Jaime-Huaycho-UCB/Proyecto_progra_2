...
public class MenuIngresarACuenta extends JFrame {
	...
	public MenuIngresarACuenta(int numeroCuenta) {
		...
		BotonTransaccion.setIcon(new ImageIcon(MenuIngresarACuenta.class.getResource("/Imagenes/icono_transferencia2.0.jpg")));
		...
		BotonCalcularInteres.setIcon(new ImageIcon(MenuIngresarACuenta.class.getResource("/Imagenes/icono_interes.png")));
		...
		BotonTransferenciaBancaria.setIcon(new ImageIcon(MenuIngresarACuenta.class.getResource("/Imagenes/icono_trans.png")));
